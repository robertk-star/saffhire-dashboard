...
function safeOrderError(raw: string) {
  ...
  if (text.includes("TAZWORKS_CLIENT_ACCESS_NOT_CONFIGURED")) return "This client dashboard is missing its assigned client GUID.";
