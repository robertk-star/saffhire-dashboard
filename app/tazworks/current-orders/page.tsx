...
export default async function CurrentOrdersPage({ searchParams }: { searchParams: Promise<{ size?: string; status?: string }> }) {
  ...
  const analyzerOnly = user.role === "analyzer";
