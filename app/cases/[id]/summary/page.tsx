...
function list(value: unknown): string[] { if (Array.isArray(value)) return value.map(toText).filter(Boolean); const one = toText(value); return one ? [one] : []; }
