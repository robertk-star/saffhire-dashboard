...
export function AppHeader({ user }: { user: SessionUser }) {
  const navItems = [["Dashboard", "/dashboard"], ["Quick Analyze", "/analyze"], ["Cases", "/cases"], ["Documents", "/documents"], ["Supervisor", "/supervisor"], ["TazWorks", "/tazworks"], ["Users", "/admin/users"], ["Audit Logs", "/admin/audit-logs"], ["Settings", "/settings"]];
  return (
